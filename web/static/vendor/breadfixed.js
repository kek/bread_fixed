...
Elm.BreadFixed.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var update = F2(function (action,model) {    var _p0 = action;return {ctor: "_Tuple2",_0: $Basics.not(model),_1: $Effects.none};});
   ...
   var main = app.html;
   return _elm.BreadFixed.values = {_op: _op,main: main,app: app,init: init,toYesNo: toYesNo,Toggle: Toggle,view: view,update: update};
};
